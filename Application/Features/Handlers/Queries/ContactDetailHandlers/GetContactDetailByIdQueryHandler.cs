...
{
    public class GetContactDetailByIdQueryHandler : IRequestHandler<GetContactDetailByIdQuery, IDataResult<ContactDetailDto>>
    {
        private readonly IContactDetailRepository _contactDetailRepository;
        private readonly IMapper _mapper;
        public GetContactDetailByIdQueryHandler(IContactDetailRepository contactRepository, IMapper mapper)
        {
        ...
        public async Task<IDataResult<ContactDetailDto>> Handle(GetContactDetailByIdQuery request, CancellationToken cancellationToken)
        {
            try
            {
                var test = await _contactDetailRepository.GetByIdAsync(request.Id);
